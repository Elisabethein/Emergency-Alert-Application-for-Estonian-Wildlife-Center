...
public class EditMyTicketDTO {
    ...
    public EditMyTicketDTO(String closeDate, String createdAt, String describedAnimal, String description, String directions, String history, String id, double latitude, String location, double longitude, String notificationSource, String openDate, Region region, Boolean reporterCanWait, String reporterEmail, String reporterName, String reporterPhone, String resolution, String species, String status, List<String> tags, boolean transportPossibility, String upperSpecies, List<User> volunteers, boolean hospital) {
